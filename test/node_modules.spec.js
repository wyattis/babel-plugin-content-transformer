  ...
  it('loads markdown as a string', () => {
    const t = babel.transform(
        ...
        export default content`,
      {
        ...
        plugins: [
          [Plugin, {
            source: 'import-test-files/simple.md',
            format: 'string'
          }]
        ]
      }
  ...
  it('loads yaml as an object', () => {
    const t = babel.transform(
      ...
      export default config`,
      {
        ...
        plugins: [
          [Plugin, {
            source: 'import-test-files/simple.yaml',
            format: 'yaml',
          }]
        ]
      }
  ...
  it('loads toml as an object', async () => {
    ...
    const t = await babel.transformAsync(
      ...
      export default config`,
      {
        ...
        plugins: [
          [Plugin, {
            source: 'import-test-files/simple.toml',
            format: 'toml',
          }]
        ]
      }
    ...
    const t = babel.transform(
      ...
      export default post`,
      {
        ...
        plugins: [[
          Plugin,
          {
            source: 'import-test-files/yaml-frontmatter.md',
            transform (contents) {
              return {
                contents
              }
